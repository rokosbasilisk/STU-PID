...
\title{RASPID: Redundancy-Aware Steering with PID Control for Efficient Language Model Generation}
...
We propose RASPID (Redundancy-Aware Steering with PID control), a novel approach that addresses these limitations through three key innovations:
